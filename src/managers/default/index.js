...
class DefaultViewManager {
  ...
  createView (section, forceRight) {
    const view = new this.View(section, extend(this.viewSettings, {
      forceRight
    }))
    view.on(EVENTS.VIEWS.RENDERING_PROGRESS, (progress) => {
      section.emit(EVENTS.SECTION.RENDERING_PROGRESS, progress, section)
    })
  ...
  display (section, target) {
    ...
    // console.debug('manager display ', this.layout.name, visible)
    ...
    // console.debug('manager add ', section)
  ...
  next () {
    ...
    // console.debug('manager goto next', this.views.length)
    ...
    if (next) {
      ...
      // console.debug('manager append next ', next)
