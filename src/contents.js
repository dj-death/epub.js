...
class Contents {
  ...
  width (w) {
    ...
    return parseInt(getComputedStyleOf(frame, 'width', this.window))
  }
  ...
  height (h) {
    ...
    return parseInt(getComputedStyleOf(frame, 'height', this.window))
  }
  ...
  contentWidth (w) {
    ...
    return parseInt(getComputedStyleOf(content, 'width', this.window))
  }
  ...
  contentHeight (h) {
    ...
    return parseInt(getComputedStyleOf(content, 'height', this.window))
  }
  ...
  overflow (overflow) {
    ...
    return getComputedStyleOf(this.documentElement, 'overflow', this.window)
  }
  ...
  overflowY (overflow) {
    ...
    return getComputedStyleOf(this.documentElement, 'overflowY', this.window)
  }
  ...
  css (property, value, priority) {
    ...
    return getComputedStyleOf(content, property, this.window)
  }
  ...
  writingMode (mode) {
    ...
    return getComputedStyleOf(this.documentElement, WRITING_MODE, this.window) || ''
  }
